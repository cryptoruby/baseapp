...
class SignUp extends React.Component<Props> {
            ...
            <div className="pg-sign-up-screen">
                <div className={className}>
                    <SignUpForm
                        ...
                        termsMessageHighlight={this.props.intl.formatMessage({ id: 'page.header.signUp.terms.highlight'})}
                        over18Label={this.props.intl.formatMessage({ id: 'page.header.signUp.over18' })}
                        refId={refId}
                        ...
                        isOver18={isOver18}
                        clickCheckBox18={this.handleCheckboxOver18Click}
    ...
    private handleCheckboxOver18Click = () => {
        this.setState({
